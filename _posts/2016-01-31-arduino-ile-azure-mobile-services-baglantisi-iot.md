...
<p style="text-align:left;"><span style="color:#000000;">Kodumuzu yazacağımız ortam ise Arduino için Java dilinde hazırlanmıştır. Kodlamada kullanılan kütüphaneler ise C ve C++ dillerinde yazılmıştır. Bu IDE’yi <span style="color:#008080;"><a style="color:#008080;" href="https://www.arduino.cc/en/Main/Software">https://www.arduino.cc/en/Main/Software</a> </span>adresinden indirip, bilgisayarınıza kurabilirsiniz.</span></p>
...
<a href="/images/dht11.png" rel="attachment wp-att-605"><img class="wp-image-605 alignnone" src="/images/dht11.png" alt="dht11" width="421" height="288" /></a>
...
<a href="/images/dht11-arduino_bb.png" rel="attachment wp-att-606"><img class="alignnone wp-image-606" src="/images/dht11-arduino_bb.png" alt="dht11-arduino_bb" width="415" height="227" />
</a>
...
<a href="/images/arduino-azure1.png" rel="attachment wp-att-608"><img class="alignnone size-full wp-image-608" src="/images/arduino-azure1.png" alt="arduino-azure1" width="484" height="322" /></a>

&nbsp;

<span style="color:#000000;">Serial Monitor;</span>

<a href="/images/arduino-azure2.png" rel="attachment wp-att-609"><img class="alignnone size-full wp-image-609" src="/images/arduino-azure2.png" alt="arduino-azure2" width="490" height="369" /></a>
...
<a href="/images/arduino-azure3.jpg" rel="attachment wp-att-610"><img class="alignnone wp-image-610" src="/images/arduino-azure3.jpg" alt="arduino-azure3" width="287" height="280" /></a> <a href="/images/arduino-azure4.jpg" rel="attachment wp-att-611"><img class="alignnone wp-image-611" src="/images/arduino-azure4.jpg" alt="arduino-azure4" width="282" height="280" /></a>
...
<span style="color:#000000;"> Serial Monitor;</span>
<a href="/images/arduino-azure6.png" rel="attachment wp-att-612"><img class="alignnone size-full wp-image-612" src="/images/arduino-azure6.png" alt="arduino-azure6" width="401" height="371" /></a>

<span style="color:#000000;">Azure Mobile Services;</span>
<a href="/images/arduino-azure7.png" rel="attachment wp-att-613"><img class="alignnone wp-image-613" src="/images/arduino-azure7.png" alt="arduino-azure7" width="523" height="298" /></a>

<span style="color:#000000;">Şekilde görüldüğü gibi verilerimizi bulut ortamına aktarmış olduk.</span>
